...
import { listAutomationRuns, onAutomationRun, runAutomationNow } from "../../lib/automationsEngine";
import type { Automation, AutomationRunSummary, TriggerEvent } from "../../lib/types";
import { AutomationIcon, PlayIcon } from "../icons";
...
export function AutomationRunsView({ automation, onOpenRun }: AutomationRunsViewProps) {
  ...
  }, [running, automation.id, automation.data, simulateEvent, refresh]);
