...
import type { NewThreadInput } from "../../lib/threads";
...
export function NewThreadForm({ onCreate, onCancel }: NewThreadFormProps) {
  ...
  return (
    <div className="thread-form">
      <div className="thread-form__header">
        <span className="thread-form__title">New thread</span>
        <button type="button" className="agent-panel__close" onClick={onCancel} aria-label="Cancel">
          <CloseIcon size={16} />
        </button>
      </div>
