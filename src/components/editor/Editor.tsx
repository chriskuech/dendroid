...
// per-heading container anymore — and `lib/tiptap/section.ts`/
...
import { DocumentWithSections, Section } from "../../lib/tiptap/section";
import { SectionStructure } from "../../lib/tiptap/sectionStructure";
import { HeadingFold } from "../../lib/tiptap/headingFold";
import { DocRoot } from "../../lib/tiptap/docRoot";
import { LinkRef } from "../../lib/tiptap/linkRef";
...
interface EditorProps {
   ...
   * (read-only, click-to-jump; see `lib/tiptap/linkRef.ts`). Reuses
  ...
  const linkRefExtension = useMemo(
    () =>
      LinkRef.configure({
        ...
        // editor (`lib/tiptap/embeddedEditor.ts`) instead of a rebuilt-DOM
